...
namespace cryptonote
{
  ...
  const uint8_t CURRENT_COIN_BLOCK_MAJOR_VERSION = 4;
  ...
  struct serializable_bytecoin_block
  {
    ...
    BEGIN_SERIALIZE_OBJECT()
      ...
      if(b.major_version > CURRENT_COIN_BLOCK_MAJOR_VERSION) return false;
  ...
  struct block_header
  {
    ...
    BEGIN_SERIALIZE()
      ...
      if(major_version > CURRENT_COIN_BLOCK_MAJOR_VERSION) return false;
